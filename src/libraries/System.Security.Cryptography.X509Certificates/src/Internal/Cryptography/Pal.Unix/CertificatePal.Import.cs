...
namespace Internal.Cryptography.Pal
{
    ...
    {
        public static ICertificatePal FromBlobOrFile(ReadOnlySpan<byte> rawData, string? fileName, SafePasswordHandle password, X509KeyStorageFlags keyStorageFlags)
        {
            ...
            try
            {
                unsafe
                {
                    ...
                    if (contentType == ContentType.CERT_QUERY_CONTENT_PKCS7_SIGNED || contentType == ContentType.CERT_QUERY_CONTENT_PKCS7_SIGNED_EMBED)
                    {
                        ...
                        throw new NotImplementedException("CERT_QUERY_CONTENT_PKCS7_SIGNED NotImplemented");
                    }
            ...
            PfxCertStoreFlags pfxCertStoreFlags)
        {
            ...
            unsafe
            {
                fixed (byte* pbRawData = rawData)
                {
                    ...
                    hStore = Interop.Crypt32.PFXImportCertStore(certBlob, password, pfxCertStoreFlags);
                    if (hStore.IsInvalid)
                    {
                        throw new CryptographicException(Marshal.GetHRForLastWin32Error());
                    }
        ...
        RSA? ICertificatePal.GetRSAPrivateKey() => throw new NotImplementedException();
        DSA? ICertificatePal.GetDSAPrivateKey() => throw new NotImplementedException();
        ECDsa? ICertificatePal.GetECDsaPrivateKey() => throw new NotImplementedException();
        ECDiffieHellman? ICertificatePal.GetECDiffieHellmanPrivateKey() => throw new NotImplementedException();
        string ICertificatePal.GetNameInfo(X509NameType nameType, bool forIssuer) => throw new NotImplementedException();
        void ICertificatePal.AppendPrivateKeyInfo(StringBuilder sb) => throw new NotImplementedException();
        ICertificatePal ICertificatePal.CopyWithPrivateKey(DSA privateKey) => throw new NotImplementedException();
        ICertificatePal ICertificatePal.CopyWithPrivateKey(ECDsa privateKey) => throw new NotImplementedException();
        ICertificatePal ICertificatePal.CopyWithPrivateKey(RSA privateKey) => throw new NotImplementedException();
        ICertificatePal ICertificatePal.CopyWithPrivateKey(ECDiffieHellman privateKey) => throw new NotImplementedException();
        PolicyData ICertificatePal.GetPolicyData() => throw new NotImplementedException();
        byte[] ICertificatePalCore.Export(X509ContentType contentType, SafePasswordHandle password) => throw new NotImplementedException();
        ...
        int ICertificatePal.Version => throw new NotImplementedException();

        bool ICertificatePal.Archived { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        string ICertificatePal.FriendlyName { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }

        X500DistinguishedName ICertificatePal.SubjectName => throw new NotImplementedException();

        X500DistinguishedName ICertificatePal.IssuerName => throw new NotImplementedException();

        IEnumerable<X509Extension> ICertificatePal.Extensions => throw new NotImplementedException();

        // ICertificatePalCore

        bool ICertificatePalCore.HasPrivateKey => throw new NotImplementedException();

        IntPtr ICertificatePalCore.Handle => throw new NotImplementedException();

        string ICertificatePalCore.Issuer => throw new NotImplementedException();

        string ICertificatePalCore.Subject => throw new NotImplementedException();

        string ICertificatePalCore.LegacyIssuer => throw new NotImplementedException();

        string ICertificatePalCore.LegacySubject => throw new NotImplementedException();

        byte[] ICertificatePalCore.Thumbprint => throw new NotImplementedException();

        string ICertificatePalCore.KeyAlgorithm => throw new NotImplementedException();

        byte[] ICertificatePalCore.KeyAlgorithmParameters => throw new NotImplementedException();

        byte[] ICertificatePalCore.PublicKeyValue => throw new NotImplementedException();

        byte[] ICertificatePalCore.SerialNumber => throw new NotImplementedException();

        string ICertificatePalCore.SignatureAlgorithm => throw new NotImplementedException();

        DateTime ICertificatePalCore.NotAfter => throw new NotImplementedException();

        DateTime ICertificatePalCore.NotBefore => throw new NotImplementedException();

        byte[] ICertificatePalCore.RawData => throw new NotImplementedException();
    }
}
