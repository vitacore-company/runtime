...
namespace Internal.Cryptography.Pal.Native
{
    ...
    internal enum CertContextPropId : uint
    {
    ...
    {
        public CRYPT_ALGORITHM_IDENTIFIER(IntPtr po, CRYPTOAPI_BLOB pars)
        {
            pszObjId = po;
            Parameters = pars;
        }
    ...
    [Flags]
    internal enum PfxCertStoreFlags : uint
    {
    ...
    [Flags]
    internal enum CertFindFlags : uint
    {
        None = 0x00000000,
    }

    internal enum CertFindType : uint
    {
